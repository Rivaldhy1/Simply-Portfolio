    ...
    <div className="h-auto grid place-items-center bg-[#E9EBEC]">
      ...
      <section className="mt-[45px] flex items-center">
        ...
        <div className="pl-[30px]">
          <h1 className="font-semibold text-3xl text-[#3D3D3D]">
            Rivaldhy Rizki A.
          </h1>
          <p className="pt-[8px] font-semibold text-[#575757] text-md">
            Software Engineer
          </p>
      ...
      <section className="mt-[18px] w-auto h-auto">
        <div className="p-5 flex justify-between items-center">
          <div className="text-center w-[148px]">
            ...
            <p className="p-header">Years of work experience</p>
          </div>
          <div className="text-center w-[148px]">
            <h1 className="h1-header">15+</h1>
            <p className="p-header">Completed Projects</p>
          </div>
          <div className="text-center w-[148px]">
            <h1 className="h1-header">4+</h1>
            <p className="p-header">Satisfied Costumer</p>
          </div>
        </div>
      </section>
      {/* Cv / Contact Button */}
      <section className="mt-4">
        <div className="flex items-center justify-between">
          <Button
            style={"bg-[#FBD144] w-[200px] font-semibold"}
            icon={downloadIcon}
          >
            Download CV
          </Button>
          <Button style={"ml-7 bg-white w-[200px] font-semibold"}>
            Contact Me
          </Button>
        </div>
      </section>
      ...
      <section className="mt-14 bg-white rounded-xl">
        <div className="flex items-center p-3">
          <Button style={"bg-[#D7D7D7] w-[240px] text-lg font-bold"}>
            Portfolio
          </Button>
          <Button style={"w-[240px] text-lg font-bold"}>Skills</Button>
        </div>
      </section>
      {/* Project Content */}
